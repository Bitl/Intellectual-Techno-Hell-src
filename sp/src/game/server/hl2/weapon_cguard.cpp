...
ConVar sk_cguard_dmg_explosion("sk_cguard_dmg_explosion", "200");
...
public:
	...
	void Explode( float magnitude )
	{
		...
		RadiusDamage(CTakeDamageInfo(this, GetOwnerEntity(), sk_cguard_dmg_explosion.GetFloat(), DMG_BLAST | DMG_DISSOLVE), GetAbsOrigin(), 256, CLASS_NONE, NULL);
