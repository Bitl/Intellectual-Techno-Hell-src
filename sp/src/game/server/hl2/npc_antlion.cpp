...
{
	//define if we wanna be a worker or not.
...
bool IsAntlionWorker( CBaseEntity *pEntity )
{
	...
	return ( pEntity != NULL && 
			 ...
			 dynamic_cast<CNPC_Antlion *>(pEntity) != NULL &&
			 dynamic_cast<CNPC_Antlion *>(pEntity)->m_bIsWorker == true);	// Save this as the last step
}
#else
bool IsAntlionWorker(CBaseEntity *pEntity)
		{
