...
ConVar	sk_combine_skeleton_health( "sk_combine_skeleton_health","0");
ConVar	sk_combine_skeleton_kick( "sk_combine_skeleton_kick","0");

extern ConVar sk_plr_dmg_buckshot;	
extern ConVar sk_plr_num_shotgun_pellets;
extern ConVar combine_spawn_health;

LINK_ENTITY_TO_CLASS( npc_combine_skeleton, CNPC_CombineSkeleton );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::Spawn( void )
{
	Precache();
	SetModel( STRING( GetModelName() ) );

	SetHealth( sk_combine_skeleton_health.GetFloat() );
	SetMaxHealth( sk_combine_skeleton_health.GetFloat() );
	SetKickDamage( sk_combine_skeleton_kick.GetFloat() );
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::Precache()
{
	SetModelName( MAKE_STRING( "models/skeleton_soldier.mdl" ) );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::PainSound(const CTakeDamageInfo &info)
{
	return;
}
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::DeathSound(const CTakeDamageInfo &info)
{
	return;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::AlertSound(void)
{
	return;
}
...
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::IdleSound(void)
{
	return;
}

void CNPC_CombineSkeleton::LostEnemySound(void)
{
	AlertSound();
}
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::FoundEnemySound(void)
{
	AlertSound();
}

void CNPC_CombineSkeleton::AnnounceEnemyType(CBaseEntity *pEnemy)
{
	AlertSound();
}

void CNPC_CombineSkeleton::AnnounceEnemyKill(CBaseEntity *pEnemy)
{
	AlertSound();
}
...
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::ClearAttackConditions( )
{
...
void CNPC_CombineSkeleton::PrescheduleThink( void )
{
...
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::BuildScheduleTestBits( void )
{
...
// Output :
//-----------------------------------------------------------------------------
int CNPC_CombineSkeleton::SelectSchedule ( void )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
float CNPC_CombineSkeleton::GetHitgroupDamageMultiplier( int iHitGroup, const CTakeDamageInfo &info )
{
	switch( iHitGroup )
	{
	case HITGROUP_HEAD:
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::HandleAnimEvent( animevent_t *pEvent )
{
	switch( pEvent->event )
	{
...
void CNPC_CombineSkeleton::OnChangeActivity( Activity eNewActivity )
{
...
void CNPC_CombineSkeleton::OnListened()
{
...
//-----------------------------------------------------------------------------
void CNPC_CombineSkeleton::Event_Killed( const CTakeDamageInfo &info )
{
...
bool CNPC_CombineSkeleton::ShouldGib(const CTakeDamageInfo &info)
{
	return false;
}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_CombineSkeleton::IsLightDamage( const CTakeDamageInfo &info )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_CombineSkeleton::IsHeavyDamage( const CTakeDamageInfo &info )
{
...
//-----------------------------------------------------------------------------
Activity CNPC_CombineSkeleton::NPC_TranslateActivity( Activity eNewActivity )
{
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CNPC_CombineSkeleton )
