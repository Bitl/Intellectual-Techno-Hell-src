...
LINK_ENTITY_TO_CLASS(npc_turret_floor, CNPC_Portal_FloorTurret);
...
void CNPC_Portal_FloorTurret::OnPhysGunDrop(CBasePlayer *pPhysGunUser, PhysGunDrop_t Reason)
{
	if (m_bCarriedByPlayer)
	{
		AddEntityRelationship(pPhysGunUser, D_LI, 1);
		AddClassRelationship(CLASS_ZOMBIE, D_HT, 1);
		AddClassRelationship(CLASS_COMBINE, D_HT, 1);
		AddClassRelationship(CLASS_COMBINE_HUNTER, D_HT, 1);
		AddClassRelationship(CLASS_HEADCRAB, D_HT, 1);
		AddClassRelationship(CLASS_METROPOLICE, D_HT, 1);
		AddClassRelationship(CLASS_SCANNER, D_HT, 1);
		AddClassRelationship(CLASS_BULLSQUID, D_HT, 1);
		AddClassRelationship(CLASS_HOUNDEYE, D_HT, 1);
		AddClassRelationship(CLASS_MANHACK, D_HT, 1);
		AddClassRelationship(CLASS_ANTLION, D_HT, 1);
	}
