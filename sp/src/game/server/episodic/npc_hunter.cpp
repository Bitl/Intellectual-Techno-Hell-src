...
ConVar hunter_flechette_speed( "hunter_flechette_speed", "6500" );
...
bool CNPC_Hunter::ShootFlechette(CBaseEntity *pTargetEntity, bool bSingleShot)
{
	...
	CTakeDamageInfo damageInfo(this, this, sk_hunter_dmg_flechette.GetFloat(), DMG_GENERIC | DMG_DISSOLVE); //tr.m_pEnt->GetHealth()
