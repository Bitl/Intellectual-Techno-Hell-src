...
STUB_WEAPON_CLASS(weapon_errorlauncher, WeaponErrorLauncher, C_BaseHLCombatWeapon);
STUB_WEAPON_CLASS(weapon_errorlauncher2, WeaponErrorLauncher2, C_BaseHLCombatWeapon);
STUB_WEAPON_CLASS(weapon_rpg2, WeaponRPG2, C_BaseHLCombatWeapon);
