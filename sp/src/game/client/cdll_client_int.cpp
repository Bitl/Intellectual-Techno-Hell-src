...
//#define TY_ECLIPSON_DLL

#ifdef TY_ECLIPSON_DLL
static ConVar ty_message("ty_message", "1", FCVAR_ARCHIVE);
#endif
...
#ifdef TY_ECLIPSON_DLL
	if (ty_message.GetBool())
	{
		ty_message.SetValue("0");
		vgui::MessageBox *pMessageBox = new vgui::MessageBox("#SMOD3_Ty_Message_Title", "#SMOD3_Ty_Message");
		pMessageBox->DoModal();
	}
#endif
