...
ConVar	sk_plr_dmg_error_round("sk_plr_dmg_error_round", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_error_round("sk_npc_dmg_error_round", "0", FCVAR_REPLICATED);
ConVar	sk_max_error_round("sk_max_error_round", "0", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("error_round", DMG_BURN, TRACER_NONE, "sk_plr_dmg_error_round", "sk_npc_dmg_error_round", "sk_max_error_round", 0, 0);
